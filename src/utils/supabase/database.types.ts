		...
		Tables: {
			...
			service_reports: {
				Row: {
					...
					dogs_cats_present: string | null;
					dogs_cats_removed: boolean | null;
					end_time: string | null;
					excessive_noise: string | null;
					excessive_noise_earmuffs: boolean | null;
					heat_cold_issue: string | null;
					...
					site_active: string | null;
					slippery_floors: string | null;
